...
| P9·5 | **Dashboard 3.0** — compact outcome cockpit strip (career-readiness top blocker + Skill Passport status) added to the dashboard, plus a grouped **Outcome** nav section | ✅ Phase 9 |
