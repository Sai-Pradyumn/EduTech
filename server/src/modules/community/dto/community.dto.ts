...
export class CreateChannelDto {
  ...
  @IsOptional() @IsEnum(['discussion', 'help', 'showcase']) kind?: 'discussion' | 'help' | 'showcase';
}
...
export class CreateThreadDto {
  ...
  @IsOptional() @IsEnum(['discussion', 'question', 'showcase']) kind?: 'discussion' | 'question' | 'showcase';
