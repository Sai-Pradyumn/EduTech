...
export type CareerReadinessStateDocument = HydratedDocument<CareerReadinessState>;
...
export const CareerReadinessStateSchema = SchemaFactory.createForClass(CareerReadinessState);
