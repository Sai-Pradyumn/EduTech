...
export class VoiceCommandRouterService {
  ...
  private readonly navRules: NavRule[] = [
    ...
    { keywords: ['visual', 'visuals', 'visual studio', 'diagram', 'mind map', 'explain visually'], route: '/app/visuals', label: 'Open Visual Studio', say: 'Opening Visual Studio.' },
    ...
    { keywords: ['skill twin', 'twin', 'what should i do next', 'next best action', 'recommend'], route: '/app/skill-twin', label: 'Open Skill Twin', say: 'Opening your Skill Twin.' },
    ...
    { keywords: ['council', 'mentor council', 'debate', 'what do the agents say'], route: '/app/mentor-council', label: 'Open Mentor Council', say: 'Convening the mentor council.' },
    { keywords: ['replay', 'recap', 'learning replay', 'what did i do'], route: '/app/replay', label: 'Open Learning Replay', say: 'Opening your learning replay.' },
    { keywords: ['ledger', 'proof of learning', 'my proof', 'achievements timeline'], route: '/app/ledger', label: 'Open Proof-of-Learning', say: 'Opening your proof of learning.' },
